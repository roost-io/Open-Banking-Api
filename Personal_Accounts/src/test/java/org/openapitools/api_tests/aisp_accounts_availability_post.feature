...
Scenario Outline: Test all the possible responses from the API
  ...
  Examples:
    ...
    | '2021-04-28T15:35:07Z' | '127.0.0.1' | '123456789' | 'en-US' | 'accountType' | 'Yes' | 200 | { data: [{ paramName: 'accountType', status: 'Yes' },{"paramName":"email","status":"Yes"},{"paramName":"phoneNumber","status":"Yes"}] } |
