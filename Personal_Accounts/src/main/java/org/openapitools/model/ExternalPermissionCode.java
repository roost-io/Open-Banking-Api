...
public enum ExternalPermissionCode {
  ...
  READACCOUNTAVAILABILITY("ReadAccountAvailability"),
  
  READACCOUNTSTATUS("ReadAccountStatus"),
  
  READACCOUNTBALANCE("ReadAccountBalance"),
  
  READACCOUNTTRANSACTION("ReadAccountTransaction");
