...
public interface ReportsApi {
     ...
     * @param reportingRequest  (optional)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "Created", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ReportingResponse.class))
            }),
    ...
    default ResponseEntity<ReportingResponse> postreports(
        ...
        @Parameter(name = "ReportingRequest", description = "") @Valid @RequestBody(required = false) ReportingRequest reportingRequest
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"reportContent\" : \"reportContent\", \"processResult\" : { \"rejectReasonList\" : [ { \"rejectReasonInfomation\" : \"rejectReasonInfomation\", \"rejectReasonCode\" : \"rejectReasonCode\" }, { \"rejectReasonInfomation\" : \"rejectReasonInfomation\", \"rejectReasonCode\" : \"rejectReasonCode\" } ], \"responseCode\" : \"00\" } }";
