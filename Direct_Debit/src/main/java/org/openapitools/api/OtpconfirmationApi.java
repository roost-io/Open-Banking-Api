...
public interface OtpconfirmationApi {
     ...
     * @param directDebitOtpConfirmationRequest  (optional)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "Created", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = DirectDebitOtpConfirmationResponse.class))
            }),
    ...
    default ResponseEntity<DirectDebitOtpConfirmationResponse> postotpconfirmation(
        ...
        @Parameter(name = "DirectDebitOtpConfirmationRequest", description = "") @Valid @RequestBody(required = false) DirectDebitOtpConfirmationRequest directDebitOtpConfirmationRequest
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"processResult\" : { \"rejectReasonList\" : [ { \"rejectReasonInfomation\" : \"rejectReasonInfomation\", \"rejectReasonCode\" : \"rejectReasonCode\" }, { \"rejectReasonInfomation\" : \"rejectReasonInfomation\", \"rejectReasonCode\" : \"rejectReasonCode\" } ], \"responseCode\" : \"00\" }, \"mandateIdentification\" : \"mandateIdentification\", \"creditorReference\" : \"creditorReference\" }";
