...
public class statusInstructionsPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/springframework/boot/RoostTest/status_instructionsPostTest.csv", envVarsList);
    }
    ...
    public void statusInstructionsPost_Test() throws JSONException {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0/direct-debit";  
              ...
              System.out.printf("Test Case %d: statusInstructionsPost_Test \n", testNumber++);
              System.out.println("Request: POST /status/instructions");
