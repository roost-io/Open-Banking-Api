...
public class directdebitconsentsPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/springframework/boot/RoostTest/direct-debit-consentsPostTest.csv", envVarsList);
    }

  
    @Test  
    public void directdebitconsentsPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0/direct-debit";  
              ...
              System.out.printf("Test Case %d: directdebitconsentsPost_Test \n", testNumber++);
              System.out.println("Request: POST /direct-debit-consents");
