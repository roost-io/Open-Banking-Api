...
Test generated for /setup_post for http method type POST in rest-assured framework
...
public class setupPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/springframework/boot/RoostTest/setupPostTest.csv", envVarsList);
    }

  
    @Test  
    public void setupPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0/direct-debit";  
				...
				.body("{\n"+
					"  \"merchantRequestIdentification\": \"" + (testData.get("merchantRequestIdentification") != null ? testData.get("merchantRequestIdentification") : "") + "\",\n" +
					"  \"creditorReference\": \"" + (testData.get("creditorReference") != null ? testData.get("creditorReference") : "") + "\",\n" +
					"  \"ultimateDebtorName\": \"" + (testData.get("ultimateDebtorName") != null ? testData.get("ultimateDebtorName") : "") + "\",\n" +
					...
					"  \"creditorName\": \"" + (testData.get("creditorName") != null ? testData.get("creditorName") : "") + "\",\n" +
					"  \"creditorAccount\": \"" + (testData.get("creditorAccount") != null ? testData.get("creditorAccount") : "") + "\",\n" +
					"  \"debtorPrivateIdentification\": \"" + (testData.get("debtorPrivateIdentification") != null ? testData.get("debtorPrivateIdentification") : "") + "\",\n" +
					"  \"debtorPrivateIdentificationSchemeName\": \"" + (testData.get("debtorPrivateIdentificationSchemeName") != null ? testData.get("debtorPrivateIdentificationSchemeName") : "") + "\",\n" +
					"  \"debtorMobileNumber\": \"" + (testData.get("debtorMobileNumber") != null ? testData.get("debtorMobileNumber") : "") + "\",\n" +
					"  \"maximumAmountCurrency\": \"" + (testData.get("maximumAmountCurrency") != null ? testData.get("maximumAmountCurrency") : "") + "\",\n" +
					"  \"maximumAmount\": \"" + (testData.get("maximumAmount") != null ? testData.get("maximumAmount") : "") + "\",\n" +
					"  \"occurrences\": \"" + (testData.get("occurrences") != null ? testData.get("occurrences") : "") + "\",\n" +
					"  \"otpHoldIndicator\": \"" + (testData.get("otpHoldIndicator") != null ? testData.get("otpHoldIndicator") : "") + "\",\n" +
              ...
              System.out.printf("Test Case %d: setupPost_Test \n", testNumber++);
              System.out.println("Request: POST /setup");
        ...
        switch(responseObj.statusCode()){
          ...
          case 500:
           ...
           break;
              ...
              if (response.get("mandateIdentification") != null) {  
                MatcherAssert.assertThat(response.get("mandateIdentification"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("mandateIdentification").length(), lessThanOrEqualTo(35));
  
          }
      
              if (response.get("otpIdentificationNumber") != null) {  
                MatcherAssert.assertThat(response.get("otpIdentificationNumber"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("otpIdentificationNumber").length(), lessThanOrEqualTo(10));
  
          }
      
              if (response.get("mobileNumber") != null) {  
                MatcherAssert.assertThat(response.get("mobileNumber"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("mobileNumber").length(), lessThanOrEqualTo(35));
  
          }
      
              if (response.get("mandateStatus") != null) {  
                MatcherAssert.assertThat(response.get("mandateStatus"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("mandateStatus"), anyOf(equalTo("PDNG"), equalTo("PDFP"), equalTo("PDOU"), equalTo("ERROR"), equalTo("ACTIVE")));
  
                MatcherAssert.assertThat(response.getString("mandateStatus").length(), lessThanOrEqualTo(6));
