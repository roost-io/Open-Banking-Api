...
Test generated for /otpconfirmation_post for http method type POST in rest-assured framework
...
public class otpconfirmationPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/springframework/boot/RoostTest/otpconfirmationPostTest.csv", envVarsList);
    }

  
    @Test  
    public void otpconfirmationPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0/direct-debit";  
				...
				.body("{\n"+
					...
					"  \"otpIdentificationNumber\": \"" + (testData.get("otpIdentificationNumber") != null ? testData.get("otpIdentificationNumber") : "") + "\",\n" +
					"  \"otpPassword\": \"" + (testData.get("otpPassword") != null ? testData.get("otpPassword") : "") + "\",\n" +
					"  \"creditorAccount\": \"" + (testData.get("creditorAccount") != null ? testData.get("creditorAccount") : "") + "\n" +
 				"}")
                .when()
                .post("/otpconfirmation")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: otpconfirmationPost_Test \n", testNumber++);
              System.out.println("Request: POST /otpconfirmation");
          ...
          case 500:
           ...
           break;
              ...
              if (response.get("mandateIdentification") != null) {  
                ...
                MatcherAssert.assertThat(response.getString("mandateIdentification").length(), lessThanOrEqualTo(64));
  
          }
      
              if (response.get("creditorReference") != null) {  
                MatcherAssert.assertThat(response.get("creditorReference"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("creditorReference").length(), lessThanOrEqualTo(35));
