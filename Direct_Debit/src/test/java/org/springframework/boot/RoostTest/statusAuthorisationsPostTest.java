...
Test generated for /status/authorisations_post for http method type POST in rest-assured framework
...
public class statusAuthorisationsPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/springframework/boot/RoostTest/status_authorisationsPostTest.csv", envVarsList);
    }
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0/direct-debit";  
				...
				.body("{\n"+
 				...
 				"}")
                .when()
                .post("/status/authorisations")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: statusAuthorisationsPost_Test \n", testNumber++);
              System.out.println("Request: POST /status/authorisations");
          ...
          case 500:
           ...
           break;
              ...
              if (response.get("mandateIdentification") != null) {  
                ...
                MatcherAssert.assertThat(response.getString("mandateIdentification").length(), greaterThanOrEqualTo(1));
  
          }
      
              if (response.get("mandateStatus") != null) {  
                MatcherAssert.assertThat(response.get("mandateStatus"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("mandateStatus"), anyOf(equalTo("ERROR"), equalTo("PDOU"), equalTo("ACTIVE"), equalTo("EXPIRED"), equalTo("DORMANT"), equalTo("SUSPENDED"), equalTo("CANCELLED"), equalTo("DELETED"), equalTo("PDNG"), equalTo("PDFP")));
  
                MatcherAssert.assertThat(response.getString("mandateStatus").length(), lessThanOrEqualTo(10));
