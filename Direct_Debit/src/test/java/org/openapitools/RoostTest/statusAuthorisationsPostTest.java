...
public class statusAuthorisationsPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/openapitools/RoostTest/status_authorisationsPostTest.csv", envVarsList);
    }

  
    @Test  
    public void statusAuthorisationsPost_Test() {
        this.setUp();
