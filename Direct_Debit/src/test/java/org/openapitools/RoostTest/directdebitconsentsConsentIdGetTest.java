...
public class directdebitconsentsConsentIdGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/openapitools/RoostTest/direct-debit-consents_consentIdGetTest.csv", envVarsList);
    }

  
    @Test  
    public void directdebitconsentsConsentIdGet_Test() {
        this.setUp();
